...
// Get/List, in general.
type ThreadSafeStore = TypedThreadSafeStore[any]

type TypedThreadSafeStore[T any] interface {
...
func NewThreadSafeStore(indexers Indexers, indices Indices) ThreadSafeStore {
	return NewTypedThreadSafeStore[any](indexers, indices)
}

func NewTypedThreadSafeStore[T any](indexers Indexers, indices Indices) TypedThreadSafeStore[T] {
